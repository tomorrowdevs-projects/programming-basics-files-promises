...
for year in range(1880,2022):
    file_to_open = r"C:\Users\Isabel\PycharmProjects\PB\programming-basics-files-promises\projects\009-names-that-reachned-number-one\babynames/yob{}.txt".format(year)
